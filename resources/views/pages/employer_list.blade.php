<x-basic-layout>
    ...
    <div class="flex flex-col bg-white m-auto p-auto">
        ...
        <div class="flex flex-wrap justify-center pb-10">
            ...
            <div class="w-1/3 p-4">
                <div class="container max-w-md items-center justify-center overflow-hidden rounded-2xl bg-slate-200 shadow-xl">
                    <div class="h-10"></div>
                    ...
                    <div class="mt-5 mb-1 px-3 text-center font-bold text-2xl">
                        <a href="{{ route('employer_details', ['id' => $employer->id]) }}">{{ $employer->company_name }}</a>
                    </div>
                    <div class="mb-5 px-3 text-center text-xl text-sky-500">{{ $employer->company_industry }}</div>
                    <blockquote>
